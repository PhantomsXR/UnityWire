...
namespace Unity.Services.Wire.Internal
{
    class WireServiceProvider : IInitializablePackageV2
    {
        ...
        internal Configuration GetConfiguration(IAccessToken token, IProjectConfiguration projectCfg)
        {
            ...
            var wireAddr = CheckRegion.IsChina? "wss://xgs.phantomsxr.com/v2/ws" : "wss://wire.unity3d.com/v2/ws";
            ...
            {
                Logger.Log("Wire will use the STAGING environment.");
                wireAddr =CheckRegion.IsChina?  "wss://xgs-stg.phantomsxr.com/v2/ws" : "wss://wire-stg.unity3d.com/v2/ws";
            }
